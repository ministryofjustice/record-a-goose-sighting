...
spec:
  ...
  tls:
  - hosts:
    - ${KUBE_NAMESPACE}-fix-deploy-file.apps.live.cloud-platform.service.justice.gov.uk
  rules:
  - host: ${KUBE_NAMESPACE}-fix-deploy-file.apps.live.cloud-platform.service.justice.gov.uk
    http:
      paths:
      - path: /
